...
class TestPersonalityCalculator {
	PersonalityCalculator pc = new PersonalityCalculator();
	/*@Test
	public void testFindPersonalityMethod() {
		String temp = "4,3,5,1,2";
		int answer[] = {4,3,5,1,2};
		assertEquals(answer,pc.findPersonality(temp));
